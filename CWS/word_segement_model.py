...
training_data,training_data_sentence_num,training_data_character_num = utils.generate_train_data("./icwb2-data/training/pku_training_BIO.utf8")
...
f = open("./icwb2-data/testing/testall_model_10epoch.txt",'a')
tag_ind = ['B','I','O','','']
